...
uint256 hashGenesisBlock("0xf929da8f1809e1517e3ce3f2bcd9593f853a6a43e8cd5f666aae62347fca3b8f");
...
const string strMessageMagic = "fjbcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // fjbcoin: 1 days
static const int64 nTargetSpacing = 120; // fjbcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal fjbcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fjbcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbe30eace5561f75b0f4720ae3c4ee8eaeca7edc782bc0300b2539352934ecd07");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "FJBCOIN coin untuk forum jual beli batam";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1447314318; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3548298;

        if (fTestNet)
        {
            block.nTime    = 1447314318;
            block.nNonce   = 953471;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x82ab7277e64c3985ef416e48fa7c249b8d1760a4b8982c31bede4ea36dd83ea0"));
